...
/*
    ...
    $( function() {
      ...
      $( "#state" ).autocomplete({
        ...
        minLength:1,
        //find the match in the capital list
        source: stateList,
        // while select a value from the drop down menu
        select: function( event, ui ) {
          // set input equal to the selection from the list
          var input = ui.item.value;
          //autocomlete the fill with the selected value, and check the answer
          $( "#state" ).text(input);
